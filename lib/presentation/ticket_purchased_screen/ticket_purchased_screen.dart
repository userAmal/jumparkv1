...
class TicketPurchasedScreen extends StatelessWidget {
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _buildTicketDetailsFrame(context),
                        SizedBox(height: 30.v),
                        Container(
  ...
  /// Section Widget
  Widget _buildTicketDetailsFrame(BuildContext context) {
    return Padding(
